...
def run_voice_activation_loop(tts_manager, stt_manager):
    print("\n[+] Aurora Voice Activation Loop is active!")
    print("[+] Waiting for wake word 'aurora'...")
    ...
    while True:
        try:
            if not is_active:
                ...
                sys.stdout.write("\r[Sleeping - Say 'hi aurora' to wake] ")
                sys.stdout.flush()
                ...
                if "aurora" in wake_input or "arora" in wake_input:
                    ...
                    if tts_manager:
                        ...
                        print("Aurora > Yes, I am listening.")
                continue
            else:
                # Active Mode: Conversational Loop
                sys.stdout.write("\r[Active - Speak command or 'bye aurora'] ")
                sys.stdout.flush()
